    ...
    <div class="col-lg-6">
      <form action="<?= BASEURL; ?>/mahasiswa/cari" method="post">
        <div class="input-group">
          <input type="text" class="form-control" placeholder="find author.." name="keyword" id="keyword" autocomplete="off">
      ...
      <ul class="list-group">
        <?php foreach ($data['mhs'] as $mhs) : ?>
          <li class="list-group-item">
            ...
            <a href="" class="badge badge-success float-right tampilModalUbah" data-toggle="modal" data-target="#formModal" data-id="">update</a>
